...
\begin{frame}[label={sec:org60efd1e}]{Motivation}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org7c9ff54}]{Phase 1: Consolidation of guidelines}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgb7589f8}]{Phase 2: Modified Heuristic Evaluation}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org8c7a714}]{Phase 3: User study}
\begin{itemize}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org1a891b7}]{Phase 3: User study}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgcfcc905}]{Phase 3: User study}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgcc2b2e6}]{Phase 3: User Study (Results)}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orga573bbd}]{Phase 3: User Study (Results)}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org0d1d6e5}]{Phase 4: Expert Evaluation}
\begin{itemize}
...
\begin{frame}[label={sec:org7985d56}]{Discussion}
...
\begin{frame}[label={sec:org6f97743}]{Some guidelines}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org5ca9283}]{Some guidelines}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org83aaa0c}]{Some guidelines}
...
\begin{frame}[label={sec:orgf723c57}]{Some guidelines}
