:PROPERTIES:
:ID:       ec702e96-667e-4a8c-b881-19757f7c6085
:END:
#+title:  Coordinator (Distributed System)

* Overview
+ Sometimes use by a [[id:21c33304-3fbe-4fc8-aa5e-63f405f0434d][Distributed System]] to guarantee consistency among resources
+ 1 or many processes acts as coordinator
+ All operation go through a sequencer that assign a number to each message
+ A [[id:6f3b6618-f9ab-415a-851d-2db57c75a890][Leader Election (Distributed Systems)]] algorithm is used to choose the next coordinator among the processes
...
+ Uses /Lamport's logical clocks/ to order events ([[id:d2cef90e-1212-4812-89ab-641c643fd134][Clock Synchronization (Distributed System)]])
