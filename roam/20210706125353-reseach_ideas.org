:PROPERTIES:
:ID:       6723a08c-1355-4c11-ace2-5ae6ab4cac46
:END:
#+title: Reseach Ideas
...
+ DuetSGX (cite:nguyen2020duetsgx) remove the need for a centralized data curator by sending user data to an enclave that only serve DUET queries, which are queries that [[id:85b60b5e-c2d1-493f-942e-e779e33a271d][Differential Privacy]] constraints.
